  ...
  return (
    <section className="relative h-[91vh] max-sm:h-[90vh] bg-[rgb(240,230,220)]">
      <div className="relative w-full h-full flex flex-col items-center">
        <div className="relative flex justify-center w-[95vw] h-[80vh] mt-10 bg-black">
          <Carousel images={images} />

          <div className="absolute bottom-8 border-r-10 border-transparent">
            <Link href="/booking">
              <button className="bg-black text-[2rem] m-5 rounded-md h-[6rem] w-[30rem] max-sm:w-[90vw] mx-1 z-10">
                <b>Make a booking</b>
              </button>
            </Link>
          </div>
